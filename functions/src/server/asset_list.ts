...
export const bist100 = {
  ...
  AHGAZ: 'AHLATCI DOGAL GAZ DAGITIM ENERJI VE YATIRIM',
  AKBNK: 'AKBANK',
  AKCNS: 'AKCANSA CIMENTO SANAYI VE TICARET',
  AKFYE: 'AKFEN YENILENEBILIR ENERJI',
  AKSA: 'AKSA AKRILIK KIMYA SANAYII',
  AKSEN: 'AKSA ENERJI URETIM',
  ALARK: 'ALARKO HOLDING',
  ALBRK: 'ALBARAKA TURK KATILIM BANKASI',
  ALFAS: 'ALFA SOLAR ENERJI SANAYI VE TICARET',
  ARCLK: 'ARCELIK',
  ASELS: 'ASELSAN ELEKTRONIK SANAYI VE TICARET',
  ASGYO: 'ASCE GAYRIMENKUL YATIRIM ORTAKLIGI',
  ASTOR: 'ASTOR ENERJI',
  BERA: 'BERA HOLDING',
  BIENY: 'BIEN YAPI URUNLERI SAN. TUR. VE TIC.',
  BIMAS: 'BIM BIRLESIK MAGAZALAR',
  BIOEN: 'BIOTREND CEVRE VE ENERJI YATIRIMLARI',
  BOBET: 'BOGAZICI BETON SANAYI VE TICARET',
  BRMEN: 'BIRLIK MENSUCAT TICARET VE SANAYI ISLETMESI',
  BRSAN: 'BORUSAN BIRLESIK BORU FABRIKALARI SANAYI VE TICARET',
  BRYAT: 'BORUSAN YATIRIM VE PAZARLAMA',
  BUCIM: 'BURSA CIMENTO FABRIKASI',
  CANTE: 'CAN2 TERMIK',
  CCOLA: 'COCA-COLA ICECEK',
  CIMSA: 'CIMSA CIMENTO SANAYI VE TICARET',
  CMENT: 'CIMENTAS IZMIR CIMENTO FABRIKASI T.A.S.',
  CWENE: 'CW ENERJI MUHENDISLIK TICARET VE SANAYI',
  DENGE: 'DENGE YATIRIM HOLDING',
  DOAS: 'DOGUS OTOMOTIV SERVIS VE TICARET',
  DOHOL: 'DOGAN SIRKETLER GRUBU HOLDING',
  ECILC: 'EIS ECZACIBASI ILAC, SINAI VE FINANSAL YATIRIMLAR SANAYI VE TICA',
  ECZYT: 'ECZACIBASI YATIRIM HOLDING ORTAKLIGI',
  ...
  EUPWR: 'EUROPOWER ENERJI VE OTOMASYON TEKNOLOJILERI SANAYI TICARET',
  EUREN: 'EUROPEN ENDUSTRI INSAAT SANAYI VE TICARET',
  FROTO: 'FORD OTOMOTIV SANAYI',
  GARAN: 'TURKIYE GARANTI BANKASI',
  GESAN: 'GIRISIM ELEKTRIK SANAYI TAAHHUT VE TICARET',
  GUBRF: 'GUBRE FABRIKALARI T.A.S.',
  GWIND: 'GALATA WIND ENERJI',
  HALKB: 'TURKIYE HALK BANKASI',
  HEKTS: 'HEKTAS TICARET T.A.S.',
  IPEKE: 'IPEK DOGAL ENERJI KAYNAKLARI ARASTIRMA VE URETIM',
  ISBIR: 'ISBIR HOLDING',
  ISCTR: 'TURKIYE IS BANKASI',
  ISDMR: 'ISKENDERUN DEMIR ve CELIK',
  ISGYO: 'IS GAYRIMENKUL YATIRIM ORTAKLIGI',
  ISMEN: 'IS YATIRIM MENKUL DEGERLER',
  ISYAT: 'IS YATIRIM ORTAKLIGI',
  IZENR: 'IZDEMIR ENERJI ELEKTRIK URETIM',
  IZMDC: 'IZMIR DEMIR CELIK SANAYI',
  IZINV: 'IZ YATIRIM HOLDING ANONIM SIRKETI',
  KARSN: 'KARSAN OTOMOTIV SANAYII VE TICARET',
  KAYSE: 'KAYSERI SEKER FABRIKASI',
  KCAER: 'KOCAER CELIK SANAYI VE TICARET',
  KCHOL: 'KOC HOLDING',
  KENT: 'KENT GIDA MADDELERI SANAYII VE TICARET',
  KLNMA: 'TURKIYE KALKINMA VE YATIRIM BANKASI',
  KLSER: 'KALESERAMIK CANAKKALE KALEBODUR SERAMIK SANAYI',
  KMPUR: 'KIMTEKS POLIURETAN SANAYI VE TICARET',
  KONTR: 'KONTROLMATIK TEKNOLOJI ENERJI ve MUHENDISLIK',
  KONYA: 'KONYA CIMENTO SANAYII',
  KORDS: 'KORDSA TEKNIK TEKSTIL',
  KOZAA: 'KOZA ANADOLU METAL MADENCILIK ISLETMELERI',
  KOZAL: 'KOZA ALTIN ISLETMELERI',
  KRDMD: 'KARDEMIR KARABUK DEMIR CELIK SANAYI VE TICARET',
  MAVI: 'MAVI GIYIM SAN VE TIC',
  MGROS: 'MIGROS TICARET',
  MIATK: 'MIA TEKNOLOJI',
  ODAS: 'ODAS ELEKTRIK URETIM SANAYI TICARET',
  OTKAR: 'OTOKAR OTOMOTIV VE SAVUNMA SANAYI',
  OYAKC: 'OYAK CIMENTO FABRIKALARI',
  PENTA: 'PENTA TEKNOLOJI URUNLERI DAGITIM TICARET',
  PETKM: 'PETKIM PETROKIMYA HOLDING',
  PGSUS: 'PEGASUS HAVA TASIMACILIGI',
  QNBFB: 'QNB FINANSBANK',
  QNBFL: 'QNB FINANS FINANSAL KIRALAMA',
  QUAGR: 'QUA GRANITE HAYAL YAPI VE URUNLERI SANAYI TICARET',
  ...
  SMRTG: 'SMART GUNES ENERJISI TEK. AR. GEL. URETIM SANAYI VE TICARET',
  SNKRN: 'SENKRON SIBER GUVENLIK YAZILIM VE BILISIM COZUMLERI',
  SOKM: 'SOK MARKETLER TICARET',
  TATEN: 'TATLIPINAR ENERJI URETIM',
  TAVHL: 'TAV HAVALIMANLARI HOLDING',
  TBORG: 'TURK TUBORG BIRA VE MALT SANAYII',
  ...
  UTPYA: 'UTOPYA TURIZM INSAAT ISLETME',
  ...
  YYLGD: 'YAYLA AGRO GIDA SANAYI VE TICARET',
